...
export default function TemplateCard({ template, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-lg border border-gray-300 p-4 cursor-pointer hover:border-blue-500 hover:shadow-sm transition-all h-32 flex flex-col justify-between"
    >
